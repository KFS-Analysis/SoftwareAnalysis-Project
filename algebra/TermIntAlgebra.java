...
/**
 * Implementation of integers consisting of a singleton value. To be used in
 * conjunction with {@link PointBoolAlgebra} and {@link PointStringAlgebra}.
 * 
...
public class TermIntAlgebra extends IntAlgebra<Expression, Expression, Expression, Expression> {
	...
	public Expression bigmin(List<Expression> arg) {
		return Op.MIN.getOperator().newTerm(arg.toArray(new Expression[arg.size()]));
	}
